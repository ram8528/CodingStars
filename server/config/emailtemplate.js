...
export const RESET_EMAIL_TEMPLATE = `
        ...
        <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
          <div style="background: linear-gradient(to right,rgb(32, 96, 155),rgb(42, 221, 215)); padding: 20px; text-align: center;">
          ...
          <div style="background-color: #f9f9f9; padding: 20px; border-radius: 0 0 5px 5px; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
            ...
            <p>If you haven't made this request, please mail us at support@codingstars.com.</p>
            <p>Best regards,<br>Coding Stars</p>
          </div>
          <div style="text-align: center; margin-top: 20px; color: #888; font-size: 0.8em;">
            <p>This is an automated message, please do not reply to this email.</p>
